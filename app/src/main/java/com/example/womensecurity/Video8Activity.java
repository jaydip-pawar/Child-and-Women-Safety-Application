...
public class Video8Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyAVV6jXxJ9jVBALY5CElnPd8loyl9pFS6A";

    public static final String VIDEO_ID = "yT6UAYCVUpo";
    ...
    public void onBackPressed() {
        Intent intent=new Intent(Video8Activity.this, VideosActivity.class);
