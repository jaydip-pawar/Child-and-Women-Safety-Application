...
public class Video3Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyAVV6jXxJ9jVBALY5CElnPd8loyl9pFS6A";

    public static final String VIDEO_ID = "BLndgXVeaU0";
    ...
    public void onBackPressed() {
        Intent intent=new Intent(Video3Activity.this, VideosActivity.class);
