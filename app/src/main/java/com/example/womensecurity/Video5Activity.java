...
public class Video5Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyAVV6jXxJ9jVBALY5CElnPd8loyl9pFS6A";

    public static final String VIDEO_ID = "7CfmcN2-dA4";
    ...
    public void onBackPressed() {
        Intent intent=new Intent(Video5Activity.this, VideosActivity.class);
