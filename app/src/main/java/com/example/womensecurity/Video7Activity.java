...
public class Video7Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyAVV6jXxJ9jVBALY5CElnPd8loyl9pFS6A";

    public static final String VIDEO_ID = "-V4vEyhWDZ0";
    ...
    public void onBackPressed() {
        Intent intent=new Intent(Video7Activity.this, VideosActivity.class);
