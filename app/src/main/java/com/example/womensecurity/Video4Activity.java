...
public class Video4Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyAVV6jXxJ9jVBALY5CElnPd8loyl9pFS6A";

    public static final String VIDEO_ID = "0UqK3tfuu8Q";
    ...
    public void onBackPressed() {
        Intent intent=new Intent(Video4Activity.this, VideosActivity.class);
